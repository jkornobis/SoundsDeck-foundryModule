...
reaches the table, and for 0.6.1 (2026-09-25), which completes his program, and for 0.6.2 (2026-09-25), private sounds, and for 0.6.3 (2026-09-25), the new look, and for 0.6.4 (2026-09-25), late joiners and the board tabs, and for 0.6.5 (2026-09-25), the track picker, the layout pass and the Stream Deck profiles, and for 0.6.6 (2026-09-25), his second program, and for 0.6.7 (2026-09-26), his UI points and vertical faders - published as 0.6.8, 0.6.7's build having failed.
